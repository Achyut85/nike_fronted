...
const Hero = () => {
  const [bigShoe, setBigShoeImage] = useState(bigShoe1)
  return (
    <section
      id="home"
    ...
    >
      ...
      >
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover styllish Nike arrivals, quality comfort, and innovation for your active life</p>
        <Button
          label="Show now"
          iconURL={arrowRight}
        />
