...
const Subscribe = () => {
  return (
   ...
   id="contact-us">
    ...
    <div className="lg:max-w-[40%] w-full flex items-center max-sm:flex-col gap-5 p-1.5 sm:border sm:border-slate-gray rounded-full">
      <input type="text" placeholder="subscribe@benike.com"
      className="input"/>
